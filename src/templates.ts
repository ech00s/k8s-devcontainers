...
export namespace templates{
 export function namespace(name:string):resource{
        ...
        export function role_binding(name:string,namespace:string,role:string,service_account:string):resource{
            return {
                apiVersion:"rbac.authorization.k8s.io/v1",
                kind:"RoleBinding",
                metadata:{
        ...
        export function pvc(name:string,namespace:string,selector:string,size_gb:number = 2):resource{
            return {
                "apiVersion": "v1",
        ...
        export function service(name:string,namespace:string,selector:string,port:number = 22):resource{
            return {
                "apiVersion": "v1",
                "kind": "Service",
                "metadata": {
        ...
        //not used for now
        export function __network_policy(
            name:string,
            namespace:string
        ):resource{
            return {
