...
export class devc_generator implements generator<devc_env_cfg> {
  generate(cfg: devc_env_cfg): resource[] {
    ...
    return [
      tpls.namespace(n.namespace),

      tpls.service_account(n.service_account, n.namespace),

      tpls.role(n.role, n.namespace),

      tpls.role_binding(n.role_binding, n.namespace, n.role, n.service_account),

      tpls.pvc(n.pvc, n.namespace, n.deployment, cfg.pvc_size),

      tpls.service(n.service, n.namespace, n.deployment),
      ...
      tpls.tcproute(n.route, n.namespace, n.gateway, n.service, "tls"),
